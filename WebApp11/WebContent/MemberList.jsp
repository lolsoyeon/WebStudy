...
<%
	...
	try 
	{
		...
		// 리스트를 얻어내기위해  MemberDAO 객체의 LIST() 호출
...
<style type="text/css">
	...
	input {width: 400px; border-radius: 6px;}
	button {width: 360px; height: 50px; font-family: 맑은 고딕; font-weight: bold;}
	input:focus {background-color: #ffeeff;}
	#memberCount {font-weight: bold; color: blue;}
...
<!-- 		<span>전체 인원수 : 10명</span> -->
		...
		<table class="table">
		 ...
		 -->
		 <%=str.toString() %>
		 <!-- toString() 안해주면 StringBuffer 타입이다.-->
