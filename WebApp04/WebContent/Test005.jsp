...
<div>
	...
	<!-- ※ form 태그의 action 속성은 데이터 전송 및 페이지 요청을
		   해야 하는 대상 페이지를 등록하는 기능 수행
		   (생략 시 데이터 전송 및 요청 페이지는 자기 자신 페이지가된다.)
	...
	<form action="/WebApp04/test005" method="get">
		...
		<table>
			<tr>
				<th>아이디</th>
				<td>
					<input type="text" name="userId" size="20" maxlength="10" class="txt">
				</td>
			</tr>
			...
			<tr>
				<th>패스워드</th>
				<td>
					<input type="password" name="userPwd" size="20" class="txt">
				</td>
			</tr>
