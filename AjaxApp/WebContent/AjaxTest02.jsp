...
// 		alert(ajax);
		...
		// 각 단계별(순차적)로 변화되며 0 부터 4 까지 순차적으로 증가한다.
		ajax.onreadystatechange = function()
		{
			// 확인
// 			alert("readystatechange 이벤트 발생 : " + ajax.readyState);
			
			// 그 중에서...(0부터 4 까지의 상태 중에서...)
			// 4가 되는 순간이
			...
			if (ajax.readyState == 4)	
			{
				...
				// 알 수 없기 때문에 서버로 부터 응답 코드를 확인한 후
		...
		// 실제 서버에서 AJXA 요청을 한다.(즉, 이 부분이 진짜 연결 작업이다.)
