...
<%
	...
	// 작업 객체 생성 및 준비된 쿼리문 수행  → excuteQuery(sql) → ResultSet 반환
...
<div>
	<form action="MenberInsert.jsp" method="post" onsubmit="return formCheck()">
		<table>
			<tr>
				<th>이름(*)</th>
				<td>
...
<div>
	<!-- 결과 리스트 구성 --> <!-- 파이널 프로젝트시 눈에 다 보이도록 작업한다-->
	<%=str %>
	<!--
	<table class="table">
		<tr>
